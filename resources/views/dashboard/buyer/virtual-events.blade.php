                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 flex items-center">
                                    ...
                                    {{ ucfirst(str_replace('_', ' ', $ticket->event->platform_type ?? 'Visioconférence')) }}
                                </p>
                            </div>
                        ...
                        <div class="space-y-2 mb-4 text-sm text-gray-600">
                            ...
                            <div class="flex items-center">
                                ...
                                <span>Durée: {{ $ticket->event->start_date->diffForHumans($ticket->event->end_date, true) }}</span>
                            </div>
                            ...
                            @if($ticket->event->meeting_password)
                                <div class="flex items-center text-xs">
                                    ...
                                    <span>Mot de passe: <strong>{{ $ticket->event->meeting_password }}</strong></span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="space-y-2 pt-4 border-t border-gray-200">
                            @if($ticket->virtual_access_token)
                                @if($ticket->event->start_date >= now())
                                    <a href="{{ $ticket->getVirtualAccessUrl() }}" target="_blank" class="block w-full bg-blue-600 text-white text-center px-4 py-3 rounded-lg hover:bg-blue-700 transition font-medium mb-2">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('tickets.download', $ticket) }}" class="text-green-600 hover:text-green-800 text-sm font-medium">
