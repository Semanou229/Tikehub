    ...
    <div class="flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        <aside id="mobile-sidebar" class="fixed lg:static inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col z-50 lg:z-auto transform lg:transform-none">
            ...
            <nav class="flex-1 p-2 sm:p-4 overflow-y-auto">
                <a href="{{ route('admin.dashboard') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-th-large w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Dashboard</span>
                </a>
                <a href="{{ route('admin.events.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.events.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-calendar-alt w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base flex-1">Événements</span>
                </a>
                <a href="{{ route('admin.users.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.users.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-users w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base flex-1">Utilisateurs</span>
                </a>
                <a href="{{ route('admin.kyc.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.kyc.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                ...
                <a href="{{ route('admin.reports.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                ...
                <a href="{{ route('admin.support.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.support.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                ...
                <a href="{{ route('admin.payments.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.payments.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-money-bill-wave w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Paiements</span>
                </a>
                <a href="{{ route('admin.withdrawals.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.withdrawals.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                ...
                <a href="{{ route('admin.contests.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.contests.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-trophy w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Concours</span>
                </a>
                <a href="{{ route('admin.fundraisings.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.fundraisings.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                ...
                <a href="{{ route('admin.blogs.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.blogs.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-newspaper w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Blog</span>
                </a>
                <a href="{{ route('admin.blog-categories.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.blog-categories.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-tags w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Catégories Blog</span>
                </a>
                <a href="{{ route('admin.faqs.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.faqs.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-question-circle w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">FAQs</span>
                </a>
                <a href="{{ route('admin.contact-info.edit') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.contact-info.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
                    <i class="fas fa-address-card w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Infos Contact</span>
                </a>
                <a href="{{ route('admin.contact-messages.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg {{ request()->routeIs('admin.contact-messages.*') ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} min-h-[44px]">
