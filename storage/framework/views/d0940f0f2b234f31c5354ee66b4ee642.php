...
<div class="p-3 sm:p-4 lg:p-6">
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <a href="<?php echo e(route('organizer.crm.contacts.create')); ?>" class="bg-indigo-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-indigo-700 active:bg-indigo-800 transition text-sm sm:text-base font-medium min-h-[44px] flex items-center justify-center">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6">
        ...
        <?php $__currentLoopData = ['participant', 'sponsor', 'vip', 'staff']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                <div class="text-xs sm:text-sm text-gray-600 mb-1"><?php echo e(ucfirst($cat)); ?>s</div>
                <div class="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-600"><?php echo e($stats['by_category'][$cat] ?? 0); ?></div>
            </div>
