<?php $__env->startSection('title', 'Modifier un Concours'); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Modifier le Concours</h1>
        <a href="<?php echo e(route('organizer.contests.index')); ?>" class="text-purple-600 hover:text-purple-800">
            <i class="fas fa-arrow-left mr-2"></i>Retour
        </a>
    </div>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="<?php echo e(route('contests.update', $contest)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $contest->name)); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Ex: Miss Bénin 2025">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Décrivez votre concours..."><?php echo e(old('description', $contest->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="rules" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Règles et conditions de participation..."><?php echo e(old('rules', $contest->rules)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($contest->cover_image): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(Storage::url($contest->cover_image)); ?>" alt="Couverture actuelle" class="w-32 h-32 object-cover rounded-lg">
                                </div>
                            <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="price_per_vote" value="<?php echo e(old('price_per_vote', $contest->price_per_vote)); ?>" min="0" step="0.01" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="100">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="points_per_vote" value="<?php echo e(old('points_per_vote', $contest->points_per_vote)); ?>" min="1" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="1">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="datetime-local" name="start_date" value="<?php echo e(old('start_date', $contest->start_date->format('Y-m-d\TH:i'))); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="end_date" value="<?php echo e(old('end_date', $contest->end_date->format('Y-m-d\TH:i'))); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                    ...
                    <div>
                        ...
                        <select name="event_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                            ...
                            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($event->id); ?>" <?php echo e(old('event_id', $contest->event_id) == $event->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 flex items-center gap-4">
                ...
                <a href="<?php echo e(route('organizer.contests.index')); ?>" class="text-gray-600 hover:text-gray-800">
                    Annuler
                </a>
            </div>
        </form>
...
<script>
let candidateIndex = <?php echo e($contest->candidates->max('number') ?? 0); ?>;
...
function updateCandidateNumbers() {
    ...
    let currentNumber = <?php echo e($contest->candidates->max('number') ?? 0); ?>;
    items.forEach((item) => {
        currentNumber++;
...
function updateNoCandidatesMessage() {
    ...
    const existingCount = <?php echo e($contest->candidates->count()); ?>;
...
<?php $__env->stopPush(); ?>
    ...
    <div class="mt-6 bg-purple-50 border-2 border-purple-200 rounded-lg p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h2 class="text-xl font-bold text-gray-800 flex items-center">
                    ...
                    Candidats (<?php echo e($contest->candidates->count()); ?>)
                </h2>
        ...
        <!-- Candidats existants -->
        <?php if($contest->candidates->count() > 0): ?>
            <div class="mb-6">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Candidats existants</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $contest->candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border-2 border-purple-200 rounded-lg p-4 bg-white">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm font-semibold text-purple-600">#<?php echo e($candidate->number); ?></span>
                                <span class="text-xs text-gray-500"><?php echo e($candidate->votes()->sum('points')); ?> points</span>
                            </div>
                            <h3 class="font-semibold text-gray-900 mb-1"><?php echo e($candidate->name); ?></h3>
                            <?php if($candidate->description): ?>
                                <p class="text-sm text-gray-600 line-clamp-2"><?php echo e(Str::limit($candidate->description, 60)); ?></p>
                            <?php endif; ?>
                            <?php if($candidate->photo): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e(Storage::url($candidate->photo)); ?>" alt="<?php echo e($candidate->name); ?>" class="w-16 h-16 object-cover rounded-lg">
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="noCandidatesMessage" class="text-center py-8 text-gray-500" style="<?php echo e($contest->candidates->count() > 0 ? 'display: none;' : ''); ?>">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\adoun\Music\Tikehub\resources\views/contests/edit.blade.php ENDPATH**/ ?>