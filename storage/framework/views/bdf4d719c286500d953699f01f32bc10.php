    ...
    <div class="max-w-md w-full">
        ...
        <div class="flex justify-center mb-4 sm:mb-6">
            <div class="bg-white rounded-lg p-1 inline-flex gap-1 sm:gap-2 shadow-md w-full sm:w-auto">
                <button id="login-tab" class="tab-button active px-3 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-md flex-1 sm:flex-none items-center justify-center" data-tab="login">
                    <i class="fas fa-sign-in-alt mr-1 sm:mr-2"></i><span>Connexion</span>
                </button>
                <button id="register-tab" class="tab-button px-3 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 text-gray-600 hover:text-indigo-600 flex-1 sm:flex-none items-center justify-center" data-tab="register">
