...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('contests.create')); ?>" class="bg-purple-600 text-white px-3 sm:px-5 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg hover:bg-purple-700 active:bg-purple-800 transition font-medium text-xs sm:text-sm lg:text-base min-h-[40px] sm:min-h-[44px] flex items-center justify-center shadow-md hover:shadow-lg">
    ...
    <?php else: ?>
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <a href="<?php echo e(route('contests.create')); ?>" class="inline-block bg-purple-600 text-white px-4 sm:px-5 lg:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-purple-700 active:bg-purple-800 transition font-medium text-xs sm:text-sm lg:text-base min-h-[40px] sm:min-h-[44px] flex items-center justify-center shadow-md hover:shadow-lg">
