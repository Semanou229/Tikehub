        ...
        <aside id="mobile-sidebar" class="fixed lg:static inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col z-50 lg:z-auto transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-in-out">
            ...
            <div class="p-3 sm:p-4 border-b border-gray-200">
                ...
                <?php if(auth()->user()->team): ?>
                    <p class="text-xs text-gray-500 mt-1 truncate"><?php echo e(auth()->user()->team->name); ?></p>
                <?php endif; ?>
            </div>

            <!-- Navigation -->
            <nav class="flex-1 p-2 sm:p-4 overflow-y-auto">
                <a href="<?php echo e(route('collaborator.dashboard')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('collaborator.dashboard') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-th-large w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Dashboard</span>
                </a>
                <a href="<?php echo e(route('collaborator.events.index')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('collaborator.events.*') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-calendar-alt w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Mes Événements</span>
                </a>
                <a href="<?php echo e(route('collaborator.tasks.index')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('collaborator.tasks.*') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-tasks w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Mes Tâches</span>
                </a>
                <a href="<?php echo e(route('collaborator.tickets.index')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('collaborator.tickets.*') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-ticket-alt w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Mes Billets</span>
                </a>
                <a href="<?php echo e(route('collaborator.profile.index')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('collaborator.profile.*') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
