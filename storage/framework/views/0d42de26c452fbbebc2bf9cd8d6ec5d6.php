...
<div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6">
    <div class="flex items-center justify-between">
        <div class="flex-1 min-w-0">
            ...
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-1 sm:mb-2 break-words">Bienvenue, <?php echo e(auth()->user()->name); ?></h1>
...
<div class="p-3 sm:p-4 lg:p-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6">
            <div class="flex items-center justify-between mb-2 sm:mb-4">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-indigo-600 break-words"><?php echo e($stats['total_tickets']); ?></p>
                </div>
            ...
            <div class="flex items-center text-xs sm:text-sm text-gray-500">
                ...
                <span class="truncate"><?php echo e($stats['upcoming_tickets']); ?> à venir</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6">
            <div class="flex items-center justify-between mb-2 sm:mb-4">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-green-600 break-words"><?php echo e($stats['upcoming_tickets']); ?></p>
                </div>
            ...
            <div class="flex items-center text-xs sm:text-sm text-gray-500">
                ...
                <span class="truncate"><?php echo e($stats['past_tickets']); ?> passés</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6">
            <div class="flex items-center justify-between mb-2 sm:mb-4">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-blue-600 break-words"><?php echo e($stats['virtual_tickets']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6 relative overflow-hidden">
            ...
            <div class="flex items-center justify-between mb-2 sm:mb-4 relative z-10">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-purple-600 break-words"><?php echo e(number_format($stats['total_spent'], 0, ',', ' ')); ?> XOF</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4 sm:mb-6">
            ...
            <a href="<?php echo e(route('buyer.tickets', ['status' => 'upcoming'])); ?>" class="text-indigo-600 hover:text-indigo-800 text-xs sm:text-sm font-medium min-h-[44px] flex items-center">
                Voir tout <i class="fas fa-arrow-right ml-1 text-xs"></i>
            </a>
        </div>
        <?php if($upcomingTicketsList->count() > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <?php $__currentLoopData = $upcomingTicketsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-lg transition">
                        <div class="flex items-start justify-between mb-2 sm:mb-3">
                            <div class="flex-1 min-w-0">
                                <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-1 break-words"><?php echo e($ticket->event->title); ?></h3>
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-0 pt-2 sm:pt-3 border-t border-gray-200">
                            <a href="<?php echo e(route('tickets.show', $ticket)); ?>" class="text-indigo-600 hover:text-indigo-800 text-xs sm:text-sm font-medium min-h-[32px] flex items-center justify-center sm:justify-start">
                                <i class="fas fa-eye mr-1 text-xs"></i>Voir le billet
                            </a>
                            <?php if($ticket->event->is_virtual && $ticket->virtual_access_token): ?>
                                <a href="<?php echo e($ticket->getVirtualAccessUrl()); ?>" target="_blank" class="bg-blue-600 text-white px-3 py-1.5 sm:py-2 rounded-lg hover:bg-blue-700 active:bg-blue-800 text-xs sm:text-sm font-medium min-h-[32px] flex items-center justify-center shadow-sm hover:shadow-md">
    ...
    <!-- Événements virtuels -->
    <?php if($virtualEventsTickets->count() > 0): ?>
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4 sm:mb-6">
                ...
                <a href="<?php echo e(route('buyer.virtual-events')); ?>" class="text-blue-600 hover:text-blue-800 text-xs sm:text-sm font-medium min-h-[44px] flex items-center">
                    Voir tout <i class="fas fa-arrow-right ml-1 text-xs"></i>
                </a>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <?php $__currentLoopData = $virtualEventsTickets->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg p-3 sm:p-4 border border-blue-200">
                        <div class="flex items-start justify-between mb-2 sm:mb-3">
                            <div class="flex-1 min-w-0">
                                <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-1 break-words"><?php echo e($ticket->event->title); ?></h3>
                                <p class="text-xs text-gray-600 truncate"><?php echo e(ucfirst(str_replace('_', ' ', $ticket->event->platform_type ?? 'Visioconférence'))); ?></p>
                            </div>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800 flex-shrink-0 ml-2">
                        ...
                        <div class="space-y-1.5 sm:space-y-2 mb-2 sm:mb-3 text-xs sm:text-sm text-gray-600">
                            ...
                            <?php if($ticket->event->virtual_access_instructions): ?>
                                <p class="text-xs text-gray-500 italic break-words"><?php echo e(\Illuminate\Support\Str::limit($ticket->event->virtual_access_instructions, 60)); ?></p>
                            <?php endif; ?>
                        </div>
                        <?php if($ticket->virtual_access_token): ?>
                            <a href="<?php echo e($ticket->getVirtualAccessUrl()); ?>" target="_blank" class="block w-full bg-blue-600 text-white text-center px-3 sm:px-4 py-2 rounded-lg hover:bg-blue-700 active:bg-blue-800 transition text-xs sm:text-sm font-medium min-h-[40px] sm:min-h-[44px] flex items-center justify-center shadow-sm hover:shadow-md">
    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4 sm:mb-6">
            ...
            <a href="<?php echo e(route('buyer.payments')); ?>" class="text-indigo-600 hover:text-indigo-800 text-xs sm:text-sm font-medium min-h-[44px] flex items-center">
                Voir tout <i class="fas fa-arrow-right ml-1 text-xs"></i>
            </a>
        </div>
                                ...
                                <td class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-900">
                                    <div class="break-words">
                                        <?php if($payment->event): ?>
                                            <?php echo e($payment->event->title); ?>

                                        <?php elseif($payment->paymentable): ?>
                                            <?php echo e(class_basename($payment->paymentable_type)); ?>: <?php echo e($payment->paymentable->name ?? $payment->paymentable->title ?? 'N/A'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlySpendingData = <?php echo json_encode($stats['monthly_spending'] ?? []); ?>;
    ...
    const categoryData = <?php echo json_encode($stats['category_spending'] ?? []); ?>;
...
<?php echo $__env->make('layouts.buyer-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\adoun\Music\Tikehub\resources\views/dashboard/buyer/index.blade.php ENDPATH**/ ?>