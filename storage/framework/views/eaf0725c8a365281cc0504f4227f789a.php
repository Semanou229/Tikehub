...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Mon Tableau de Bord - ' . config('app.name')); ?></title>
    ...
    <div class="flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        <aside id="mobile-sidebar" class="fixed lg:static inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col z-50 lg:z-auto transform lg:transform-none">
            ...
            <nav class="flex-1 p-2 sm:p-4 overflow-y-auto">
                <a href="<?php echo e(route('buyer.dashboard')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('buyer.dashboard') ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-th-large w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Tableau de bord</span>
                </a>
                <a href="<?php echo e(route('buyer.tickets')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('buyer.tickets') ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-ticket-alt w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Mes Billets</span>
                </a>
                <a href="<?php echo e(route('buyer.virtual-events')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('buyer.virtual-events') ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-video w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Événements Virtuels</span>
                </a>
                <a href="<?php echo e(route('buyer.payments')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('buyer.payments') ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
                    <i class="fas fa-credit-card w-5 mr-2 sm:mr-3 flex-shrink-0"></i>
                    <span class="text-sm sm:text-base">Mes Paiements</span>
                </a>
                <a href="<?php echo e(route('home')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg text-gray-700 hover:bg-gray-100 min-h-[44px]">
                ...
                <a href="<?php echo e(route('buyer.profile')); ?>" onclick="closeSidebarOnMobile()" class="flex items-center px-3 sm:px-4 py-2.5 sm:py-3 mb-2 rounded-lg <?php echo e(request()->routeIs('buyer.profile*') ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> min-h-[44px]">
...
<?php /**PATH C:\Users\adoun\Music\Tikehub\resources\views/layouts/buyer-dashboard.blade.php ENDPATH**/ ?>